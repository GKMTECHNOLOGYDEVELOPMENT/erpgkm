...
/**
 * Crear orden de trabajo a partir de un ticket evaluado
 */
/**
 * Crear orden de trabajo a partir de un ticket evaluado
 */
public function crearOrdenTrabajo($idTicket)
{
    try {
        ...
        // PASO 3: Crear la orden de trabajo (SIN generar nuevo número)
        Log::info('Creando orden de trabajo...');
        
        // Usar el mismo número de ticket del ticket original
        $nroTicket = $ticket->numero_ticket; // USAR EL MISMO NÚMERO
        ...
        $ordenData = [
            ...
            'linkubicacion' => $ticket->ubicacionGoogleMaps ?? '',
            'lat' => null,
            'lng' => null,
            'evaluaciontienda' => 0
        ];
