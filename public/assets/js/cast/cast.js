document.addEventListener("alpine:init", () => {
    ...
    // Botón Editar
    if (window.permisosTiendas.puedeEditar) {
        botones += `
    ...
    // Botón Eliminar
    if (window.permisosTiendas.puedeEliminar) {
        botones += `
    ...
    if (!window.permisosTiendas.puedeEditar && !window.permisosTiendas.puedeEliminar) {
