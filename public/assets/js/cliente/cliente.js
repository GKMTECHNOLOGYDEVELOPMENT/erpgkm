document.addEventListener("alpine:init", () => {
                    ...
                    },
                    {
                        ...
                        render: (_, __, row) => {
                            ...
                            if (window.permisos.puedeEditar) {
                                botones += `
                                    <a href="/cliente/${row.idCliente}/edit" x-tooltip="Editar">
                            ...
                            if (window.permisos.puedeEliminar) {
                                botones += `
                                    <button type="button" x-tooltip="Eliminar" class="text-danger" onclick="window.deleteCliente(${row.idCliente})">
    ...
    // Función global para eliminar clientes
