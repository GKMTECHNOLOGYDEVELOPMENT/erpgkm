    ...
    Alpine.data('multipleTable', () => ({
        ...
        fetchDataAndInitTable() {
            fetch('/api/ordenes')
                ...
                .then((data) => {
                    this.ordenesData = data;

                    // Inicializar DataTable
                    this.datatable1 = new simpleDatatables.DataTable('#myTable1', {
                        data: {
                            headings: ['Acciones','Ticket', 'Marca','Modelo','Serie','Estado','Técnico'],
        ...
        formatDataForTable(data) {
            return data.map((orden) => [
                ...
                `<div style="text-align: center;">${orden.marca || 'N/A'}</div>`,
                `<div style="text-align: center;">${orden.modelo || 'N/A'}</div>`,
                `<div style="text-align: center;">${orden.serie || 'N/A'}</div>`,
