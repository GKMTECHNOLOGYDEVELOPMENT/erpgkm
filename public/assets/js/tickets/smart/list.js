document.addEventListener('alpine:init', () => {
    Alpine.data('multipleTable', () => ({
        ...
        marcaFilter: '', // ✅ Agrega esto también si no lo tienes
        marcas: [], // ✅ AÑADE ESTA LÍNEA
        startDate: '',
        endDate: '',
        isLoading: false,
        ...
        init() {
            this.$nextTick(async () => {
                ...
                // ✅ Inicializar marcaFilter si no está definido
                this.marcaFilter = this.marcaFilter || '';
                ...
                this.$watch('marcaFilter', () => this.debouncedFetch()); // ✅ Agrega watch para marcaFilter
        ...
        getEditButton(data) {
            let botones = '<div class="flex justify-center items-center">';

            // Botón Editar - verificar permiso
            if (window.permisosSmart.puedeEditar) {
                botones += `
            ...
            if (window.permisosSmart.puedeVerPDF) {
                botones += `
            ...
            if (!window.permisosSmart.puedeEditar && !window.permisosSmart.puedeVerPDF) {
        ...
        toggleRowDetails(id) {
            ...
            if (currentRow.next().hasClass('expanded-row')) {
                ...
                if (record) {
                    ...
                    const justificacionItem = transiciones.find((t) => t.idVisitas === ultimaVisitaId && t.idEstadoots === 3);
