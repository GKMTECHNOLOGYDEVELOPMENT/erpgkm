document.addEventListener('alpine:init', () => {
    Alpine.data('multipleTable', () => ({
        ...
        fetchDataAndInitTable(page = 1) {
            this.isLoading = true;
            let url = `/api/ordenes?page=${page}&tipoTicket=2`;
            ...
            return data.map(orden => {
                ...
                return [
                    ...
                    `<div class="flex justify-center items-center">
                        <a href="/ordenes/helpdesk/${orden.tipoServicio == 1 ? 'levantamiento' : 'soporte'}/${orden.idTickets}/edit" class="ltr:mr-2 rtl:ml-2" x-tooltip="Editar">
