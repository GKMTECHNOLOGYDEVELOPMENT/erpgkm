    ...
    Alpine.data('multipleTable', () => ({
        ...
        initTable() {
            this.datatable = $('#myTable1').DataTable({
                ...
                columns: [
                    // { data: 'idUbicacion', className: 'text-center' },
                        ...
                        render: (_, __, row) => {
                            return `
                                <div class="flex justify-center gap-2">
                                     <a href="/ubicaciones/${row.idUbicacion}/edit" class="ltr:mr-2 rtl:ml-2" x-tooltip="Editar">
                                        ...
                                        <path opacity="0.5" d="M14.36 4.07812C14.36 4.07812 14.4759 6.04774 16.2138 7.78564C17.9517 9.52354 19.9213 9.6394 19.9213 9.6394M4.19789 21.6777L2.32178 19.8015" stroke="currentColor" stroke-width="1.5" />
                                                ...
                                                <button type="button" class="ltr:mr-2 rtl:ml-2" @click="deleteArticulo(${row.idUbicacion})" x-tooltip="Eliminar">
