                        ...
                        },
                        {
                            ...
                            render: (_, __, row) => {
                                ...
                                <div class="flex justify-center items-center gap-2">
                                    <a href="/articulos/${row.idArticulos}/edit" class="ltr:mr-2 rtl:ml-2" x-tooltip="Editar">
                                    ...
                                    <a href="/articulos/${row.idArticulos}/detalles" class="ltr:mr-2 rtl:ml-2" x-tooltip="Información detallada">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4.5 h-4.5">
...
<a href="/articulos/${row.idArticulos}/imagen" class="ltr:mr-2 rtl:ml-2" x-tooltip="Gestionar Imagen">
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4.5 h-4.5">
