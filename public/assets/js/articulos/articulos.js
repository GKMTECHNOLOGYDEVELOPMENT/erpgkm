    ...
    Alpine.data('multipleTable', () => ({
        ...
        formatDataForTable(data) {
            return data.map((articulo) => [
                ...
                articulo.estado === 'Activo'
                    ...
                    <a href="/articulos/${articulo.idArticulos}/edit" class="ltr:mr-2 rtl:ml-2" x-tooltip="Editar"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4.5 h-4.5">
                    ...
                    <button type="button" x-tooltip="Eliminar" @click="deleteArticulo(${articulo.idArticulos})"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5">
        ...
        deleteArticulo(idArticulos) {
            new window.Swal({
                ...
                if (result.value) {
                    console.log(`Iniciando eliminación del artículo con ID: ${idArticulos}`);

                    // Hacer la solicitud de eliminación
                    fetch(`/articulos/${idArticulos}`, {
                        method: 'DELETE',
                        headers: {
