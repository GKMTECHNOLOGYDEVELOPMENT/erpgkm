    ...
    <nav x-data="sidebar"
        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                                ...
                                @if (PermisoHelper::tienePermiso('VER CALENDARIO'))
                                    <li class="nav-item">
                                        <a href="{{ route('apps.calendar') }}" class="group">
                                            <div class="flex items-center">
                                                <svg class="group-hover:!text-primary shrink-0" width="20"
                ...
                <li class="menu nav-item">
                    <a href="{{ route('areas.index') }}" class="nav-link group">
                        <div class="flex items-center">
                            <!-- Icono para Áreas -->
                            ...
                            <div class="flex items-center">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path d="M4 7H20L19 21H5L4 7Z" stroke="currentColor" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M9 11V13" stroke="currentColor" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M15 11V13" stroke="currentColor" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                ...
                @if (PermisoHelper::tienePermiso('VER DETALLES DEL ARTICULO'))
                    <li class="menu nav-item">
                        <button type="button" class="nav-link group"
                            ...
                            <div class="rtl:rotate-180"
                                :class="{ '!rotate-90': activeDropdown === 'caracteristicas' }">
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <button type="button" class="nav-link group" :class="{ 'active': activeDropdown === 'Repuesto' }"
                        ...
                        <div class="flex items-center">
                            <svg class="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24"
                                ...
                                <path
                                    d="M12 5L8 9H6C4.34315 9 3 10.3431 3 12V15C3 16.6569 4.34315 18 6 18H9C10.6569 18 12 16.6569 12 15V13L16 9H18C19.6569 9 21 7.65685 21 6V3"
                                    stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            ...
                            <span
                                class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Repuestos</span>
                        </div>
            ...
            --}}
                ...
                @if (PermisoHelper::tienePermiso('VER ALMACEN'))
                    <li class="menu nav-item">
                        ...
                        <ul x-cloak x-show="activeDropdown === 'ubicaciones'" x-collapse
                            class="sub-menu text-gray-500">
                ...
                @if (PermisoHelper::tienePermiso('VER DEVOLUCIONES'))
                    <li class="menu nav-item">
                            ...
                            <div class="flex items-center">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path d="M8 12L5 15L8 18" stroke="currentColor" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M5 15H13" stroke="currentColor" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                        ...
                        <ul x-cloak x-show="activeDropdown === 'devoluciones'" x-collapse
                            class="sub-menu text-gray-500">
                            <li>
                    ...
                    @if (PermisoHelper::tienePermiso('VER ORDENES DE TRABAJO'))
                        <button type="button" class="nav-link group"
                            ...
                            <div class="flex items-center">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="group-hover:!text-primary shrink-0 w-6 h-6" fill="none"
                        ...
                        <div class="flex items-center">
                            ...
                            <svg class="group-hover:!text-primary shrink-0" width="20" height="20"
                                ...
                                <path d="M17 9H7V7C7 4.79086 8.79086 3 11 3H13C15.2091 3 17 4.79086 17 7V9Z"
                                    ...
                                    stroke-linejoin="round" />
                                <rect x="5" y="9" width="14" height="12" rx="2" stroke="currentColor"
