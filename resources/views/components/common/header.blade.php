...
.custom-ping {
    ...
    background-color: rgba(34, 197, 94, 0.5); /* equivalente a bg-success/50 */
                ...
                <a href="javascript:;" class="relative block p-2 rounded-full bg-white-light/40 dark:bg-dark/40
                        ...
                        <template x-if="notifications.length">
                            <span class="flex absolute w-3 h-3 ltr:right-0 rtl:left-0 top-0">
                                <span class="custom-ping"></span>
                                <span class="relative inline-flex rounded-full w-[6px] h-[6px] bg-green-500 z-10"></span>
                            </span>
                        </template>
            ...
            <div class="p-4">
                ...
                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                    ...
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                            ...
                            <div class="flex items-center px-4 py-4">
                                <div class="flex-none">
                                    <img class="rounded-md w-10 h-10 object-cover"
                                        src="{{ isset($usuario) && $usuario->avatar ? asset('storage/avatars/' . $usuario->avatar) : '/assets/images/user-profile.jpeg' }}"
                                        alt="image" />
                                </div>
                        ...
                        <li>
                            <a href="{{ route('perfil') }}" class="dark:hover:text-white" @click="toggle">
                        ...
                        <li>
                            <a href="{{ route('auth.lockscreen') }}" class="dark:hover:text-white" @click="toggle">
                                <svg class="w-4.5 h-4.5 ltr:mr-2 rtl:ml-2 shrink-0" width="18" height="18"
                                    viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
