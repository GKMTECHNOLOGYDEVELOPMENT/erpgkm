  ...
  <div>
      ...
      <div class="panel mt-6 p-5 max-w-4xl mx-auto">
        <h2 class="text-xl font-bold mb-5 flex items-center">
            <i class="fas fa-edit text-primary mr-2"></i> Editar Subcategoría
        </h2>

        <form id="subcategoriaForm" method="POST">
            @csrf
            @method('PUT') {{-- Spoof method --}}
            <input type="hidden" id="subcategoriaId" value="{{ $subcategoria->id }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="relative input-with-icon">
                    ...
                    <input id="nombre" name="nombre" type="text" class="clean-input w-full"
                           placeholder="Nombre de la subcategoría" value="{{ $subcategoria->nombre }}">
                </div>
                ...
                <div class="relative input-with-icon md:col-span-2">
                    ...
                    <textarea id="descripcion" name="descripcion" rows="3"
                              ...
                              placeholder="Descripción de la subcategoría">{{ $subcategoria->descripcion }}</textarea>
                </div>
            </div>
            ...
            <div class="flex justify-end mt-6 gap-4">
                ...
                <button type="button" id="btnGuardar" class="btn btn-primary flex items-center">
                    <i class="fas fa-save mr-2"></i> Actualizar Subcategoría
                </button>
            </div>
        </form>
    </div>
    ...
    <script>
    window.idSubcategoria = {{ $subcategoria->id ?? 'null' }};
</script>
  ...
  <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            btnGuardar.addEventListener("click", function () {
                ...
                fetch(`/subcategoria/update/${subcategoriaId}`, {
                    method: "POST",
                    headers: {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        setTimeout(() => {
                            window.location.href = "{{ route('subcategoria.index') }}";
                        }, 1500);
                    } else {
    ...
    <script src="{{ asset('assets/js/almacen/subcategoria/subcategoriaValidacionesupdate.js') }}"></script>
