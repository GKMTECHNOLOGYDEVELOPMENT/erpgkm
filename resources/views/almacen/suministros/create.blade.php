<x-layout.default>
    ...
    <div>
        <ul class="flex space-x-2 rtl:space-x-reverse">
            ...
            <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
                <span>Crear nuevo suministro</span>
            </li>
        </ul>
    </div>
    ...
    <div class="panel mt-6 p-5 max-w-4xl mx-auto">
        <h2 class="text-xl font-bold mb-5 flex items-center">
            <i class="fas fa-boxes text-primary mr-2"></i> Agregar Nuevo Suministro
        </h2>

        <form id="suministroForm" method="POST" action="#" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="relative">
                    ...
                    <div class="relative mt-1">
                        ...
                        <input id="nombre" name="nombre" type="text" class="clean-input w-full" placeholder="Ingrese nombre del suministro" required>
                    </div>
                </div>
...
<iframe id="pdf_viewer" class="w-full h-[600px] border rounded" type="application/pdf"></iframe>
            ...
            <div class="flex justify-end mt-6">
                ...
                <button type="submit" class="btn btn-primary ml-4 flex items-center">
                    <i class="fas fa-save mr-1"></i> Guardar Suministro
                </button>
            </div>
        </form>
    </div>
