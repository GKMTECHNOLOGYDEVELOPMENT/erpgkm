<x-layout.default>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-3 group">
                            ...
                            <div class="relative">
                                <select id="usuarioSelect"
                                    ...
                                    <option value="1" class="text-gray-700">Juan Pérez - Desarrollo</option>
                                    <option value="2" class="text-gray-700">María García - Marketing</option>
                                    <option value="3" class="text-gray-700">Carlos López - Finanzas</option>
                                    <option value="4" class="text-gray-700">Ana Rodríguez - RH</option>
                                </select>
                        ...
                        <div class="space-y-3 group">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                                        ...
                                        <div class="md:col-span-6">
                                            ...
                                            <select class="articulo-select w-full px-3 py-2.5 bg-white border border-gray-300 rounded-lg focus:border-success focus:ring-2 focus:ring-success/20 transition-all duration-200">
                                                ...
                                                <optgroup label="Equipos Informáticos" class="text-gray-500">
                                                    <option value="1" data-stock="5" data-serie="HP-ELITE-2023-001">Laptop HP EliteBook</option>
                                                    <option value="2" data-stock="3" data-serie="DL-MON-24-2023">Monitor Dell 24"</option>
                                                    <option value="3" data-stock="2" data-serie="MBP-M1-2023-001">MacBook Pro M1</option>
                                                </optgroup>
                                                <optgroup label="Periféricos" class="text-gray-500">
                                                    <option value="4" data-stock="12">Mouse Logitech MX</option>
                                                    <option value="5" data-stock="8">Teclado Mecánico</option>
                                                    <option value="6" data-stock="6">Audífonos Sony</option>
                                                </optgroup>
                                            </select>
                                        </div>
                            ...
                            <div class="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                                ...
                                <span id="totalArticulos" class="text-lg font-bold text-primary">1</span>
                            </div>
                        </div>
    ...
    <style>
        ...
        .articulos-scroll-container {
            ...
            overflow-y: auto; /* Scroll vertical cuando se necesita */
        ...
        /* Cuando hay pocos artículos, mostrar scroll solo si es necesario */
        .articulos-scroll-container.scroll-activo {
            max-height: 400px;
            overflow-y: auto;
        }

        /* Clase para ocultar scroll cuando no es necesario */
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function actualizarScroll() {
                ...
                // Calcular altura total de los artículos
                let alturaTotal = 0;
                articulosItems.forEach(item => {
                    alturaTotal += item.offsetHeight + 16; // 16px por el gap
                });
                
                // Activar scroll si la altura supera los 400px
                if (alturaTotal > 400) {
            ...
            // Función para actualizar el stock y número de serie cuando se selecciona un artículo
            function actualizarArticulo(selectElement) {
                ...
                if (selectElement.value) {
                    ...
                    // Mostrar campo de número de serie si el artículo tiene número de serie
                    if (serie) {
                        serieContainer.classList.remove('hidden');
                        serieInput.value = serie;
                        serieInput.readOnly = false;
                        serieInput.classList.remove('bg-gray-100');
                    } else {
                        serieContainer.classList.add('hidden');
                        serieInput.value = '';
                        serieInput.readOnly = true;
                        serieInput.classList.add('bg-gray-100');
                    }
                } else {
            ...
            // Validar antes de crear la asignación
            document.getElementById('crearAsignacionBtn').addEventListener('click', function() {
                ...
                const articulosSeleccionados = document.querySelectorAll('.articulo-select[value!=""]');
                ...
                document.querySelectorAll('.articulo-item').forEach(item => {
                    const select = item.querySelector('.articulo-select');
                    const cantidad = item.querySelector('.articulo-cantidad');
                    const serieInput = item.querySelector('.articulo-serie-input');
                    const stock = parseInt(item.querySelector('.stock-info span').textContent) || 0;
                    ...
                    if (select.value) {
                        ...
                        articulosData.push(articuloData);
                        
                        if (articuloData.cantidad > stock) {
                            errorCantidad = true;
                            cantidad.classList.add('border-danger');
                            alert(`La cantidad para "${articuloData.nombre}" excede el stock disponible (${stock})`);
                        } else {
                ...
                // window.location.href = "{{ route('asignar-articulos.index') }}";
            });
        });
    </script>
</x-layout.default>