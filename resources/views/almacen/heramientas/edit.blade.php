<x-layout.default>
        ...
        <ul class="flex space-x-2 rtl:space-x-reverse">
            <li>
                <a href="{{ route('heramientas.index') }}" class="text-primary hover:underline">
                    <i class="fas fa-arrow-left mr-1"></i> Heramienta
                </a>
            </li>
            <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
                <span>Editar Heramienta</span>
            </li>
        </ul>
    </div>
    ...
    <div class="panel mt-6 p-5 max-w-6x2 mx-auto">
        ...
        <form id="heramientasForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Foto y Ficha Técnica en una sola fila -->
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById("btnGuardar").addEventListener("click", function() {
                ...
                const url = `/heramientas/update/${idArticulo}`;
    ...
    <script src="{{ asset('assets/js/almacen/heramientas/heramientasValidacionesUpdate.js') }}"></script>
    <!-- Toastr JS -->
