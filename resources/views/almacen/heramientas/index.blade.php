<x-layout.default title="Herramientas - ERP Solutions Force">
        ...
        <div class="panel mt-6">
            <div class="md:absolute md:top-5 ltr:md:left-5 rtl:md:right-5">
                <div class="flex flex-wrap items-center justify-center gap-2 mb-5 sm:justify-start md:flex-nowrap">
                    @if(\App\Helpers\PermisoHelper::tienePermiso('DESCARGAR EXCEL HERRAMIENTAS'))
                    ...
                    @if(\App\Helpers\PermisoHelper::tienePermiso('DESCARGAR PDF HERRAMIENTAS'))
                    ...
                    @if(\App\Helpers\PermisoHelper::tienePermiso('AGREGAR HERRAMIENTAS'))
                    <!-- Botón Agregar -->
    ...
    <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>
     ...
     <script>
    window.permisos = {
        puedeEditar: {{ \App\Helpers\PermisoHelper::tienePermiso('EDITAR HERRAMIENTAS') ? 'true' : 'false' }},
        puedeEliminar: {{ \App\Helpers\PermisoHelper::tienePermiso('ELIMINAR HERRAMIENTAS') ? 'true' : 'false' }},
        puedeVerdetalles: {{ \App\Helpers\PermisoHelper::tienePermiso('VER DETALLES HERRAMIENTAS') ? 'true' : 'false' }},
        puedeVerseries: {{ \App\Helpers\PermisoHelper::tienePermiso('VER SERIES HERRAMIENTAS') ? 'true' : 'false' }},
        puedeSeleccionarCliente: {{ \App\Helpers\PermisoHelper::tienePermiso('SELECCIONAR CLIENTE HERRAMIENTAS') ? 'true' : 'false' }},
    };
</script>
