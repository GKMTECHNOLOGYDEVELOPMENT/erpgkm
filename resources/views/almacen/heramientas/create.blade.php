<x-layout.default>
    ...
    <div>
        <ul class="flex space-x-2 rtl:space-x-reverse">
            <li>
                <a href="{{ route('articulos.index') }}" class="text-primary hover:underline">Heramienta</a>
            </li>
            <li class="before:content-['/'] ltr:before:mr-1 rtl:before:ml-1">
                <span>Crear Heramienta</span>
            </li>
        </ul>
    </div>

    <div class="panel mt-6 p-5 max-w-4xl mx-auto">
        <h2 class="text-xl font-bold mb-5">Agregar Nuevo Heramienta</h2>
        ...
        <form id="articuloForm" method="POST" action="{{ route('articulos.store') }}" enctype="multipart/form-data">
            ...
            <div class="flex justify-end mt-6">
                ...
                <button type="submit" class="btn btn-primary ml-4">Guardar Heramienta</button>
            </div>
        </form>
    </div>
