<x-layout.default>
    ...
    <div class="panel mt-6 p-5 max-w-6x2 mx-auto">
        ...
        <form id="heramientasForm" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="relative input-with-icon">
                    ...
                    <div class="relative mt-1">
                        ...
                        <div class="relative mt-1">
                            ...
                            <select id="idModelo" name="idModelo" class="select2-single clean-input w-full pl-10"
                                required>
                ...
                <div class="mb-5">
                    ...
                    <div id="preview_pdf" class="mt-4 max-w-full">
                        ...
                        <iframe id="pdf_viewer" class="w-full h-64 border rounded" type="application/pdf"></iframe>
                    </div>
                </div>
            ...
            <div class="flex justify-end mt-6 gap-4">
                ...
                <button type="button" id="btnGuardar" class="btn btn-primary flex items-center">
                    <i class="fas fa-save mr-2"></i> Guardar Heramienta
                </button>
            </div>
        </form>
    </div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById("btnGuardar").addEventListener("click", function() {
                ...
                fetch("/heramientas/store", {
                    ...
                    .then(data => {
                        if (data.success) {
                            toastr.success("Heramienta guardada correctamente");
    ...
    <script src="{{ asset('assets/js/almacen/heramientas/heramientasValidaciones.js') }}"></script>
