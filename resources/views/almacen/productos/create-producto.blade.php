<x-layout.default>
    ...
    <div>
        <ul class="flex space-x-2 rtl:space-x-reverse">
            <li>
                <a href="{{ route('articulos.index') }}" class="text-primary hover:underline">Producto</a>
            </li>
    ...
    <div class="panel mt-6 p-5 max-w-4xl mx-auto">
        <h2 class="text-xl font-bold mb-5">Agregar Nuevo Producto</h2>
        ...
        <form id="articuloForm" method="POST" action="{{ route('articulos.store') }}" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <!-- Código Repuesto -->
                <div>
                    <label for="codigo_repuesto" class="block text-sm font-medium">Código RFD</label>
...
<div>
    ...
    <select id="idModelo" name="idModelo" class="select2 w-full" style="display: none">
        <option value="" disabled {{ !isset($modeloSeleccionado) ? 'selected' : '' }}>Seleccionar Modelo</option>
        ...
        @endforeach
            ...
            <div class="flex justify-end mt-6">
                ...
                <button type="submit" class="btn btn-primary ml-4">Guardar Producto</button>
            </div>
        </form>
    </div>
