...
<!-- Mostrar la URL dinámica para copiar -->
<p id="firmaUrl" class="text-center mt-4">
    <span id="firmaUrlText" class="text-blue-500 font-semibold"></span>
</p>
...
<!-- Script para construir la URL dinámica -->
<script>
