            ...
            <div class="flex-1 overflow-y-auto px-4 sm:px-6 py-4">
                @php
                    $tieneEstados = \App\Helpers\PermisoHelper::tienePermiso(
                        'VER HISTORIAL DE ESTADOS SOPORTE ORDEN DE TRABAJO HELPDESK',
                    );
                    $tieneHistorial = \App\Helpers\PermisoHelper::tienePermiso(
                        'VER HISTORIAL DE CAMBIOS ORDEN DE TRABAJO HELPDESK',
                    );
                @endphp
...
function init() {
    ...
    initializeFieldValues();
        ...
        // Manejar cambios en inputs/textarea (solo al salir = blur)
        ...
        // Manejar cambios en selects y otros campos (change inmediato)
...
document.addEventListener('DOMContentLoaded', function() {
    const idClienteGeneral = $('#idClienteGeneral').val();
    if (idClienteGeneral) {
        setTimeout(() => {
            cargarContactosPorClienteGeneral(idClienteGeneral);
        }, 500);
