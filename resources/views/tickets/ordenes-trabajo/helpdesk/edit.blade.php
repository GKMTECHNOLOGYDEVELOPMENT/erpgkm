<x-layout.default>
    ...
    @php
        // Verificar permisos para Helpdesk
        $tienePermisoDetalle = \App\Helpers\PermisoHelper::tienePermiso('VER DETALLE ORDEN DE TRABAJO HELPDESK');
        $tienePermisoVisitas = \App\Helpers\PermisoHelper::tienePermiso('VER VISITAS ORDEN DE TRABAJO HELPDESK');
        $tienePermisoDesarrollo = \App\Helpers\PermisoHelper::tienePermiso('VER DESARROLLO ORDEN DE TRABAJO HELPDESK');
        $tienePermisoConstancia = \App\Helpers\PermisoHelper::tienePermiso('VER CONSTANCIA ORDEN DE TRABAJO HELPDESK');
        $tienePermisoRetorno = \App\Helpers\PermisoHelper::tienePermiso('VER RETORNO ORDEN DE TRABAJO HELPDESK');
        $tienePermisoImagenes = \App\Helpers\PermisoHelper::tienePermiso('VER IMAGENES ORDEN DE TRABAJO HELPDESK');
        $tienePermisoRecursos = \App\Helpers\PermisoHelper::tienePermiso('VER RECURSOS ORDEN DE TRABAJO HELPDESK');
        $tienePermisoFirmas = \App\Helpers\PermisoHelper::tienePermiso('VER FIRMAS ORDEN DE TRABAJO HELPDESK');
        $tienePermisoInforme = \App\Helpers\PermisoHelper::tienePermiso('VER INFORME ORDEN DE TRABAJO HELPDESK');
        $tienePermisoConformidad = \App\Helpers\PermisoHelper::tienePermiso('VER CONFORMIDAD ORDEN DE TRABAJO HELPDESK');
        
        $tieneAlgunPermiso = $tienePermisoDetalle || $tienePermisoVisitas || $tienePermisoDesarrollo || 
                            $tienePermisoConstancia || $tienePermisoRetorno || $tienePermisoImagenes || 
                            $tienePermisoRecursos || $tienePermisoFirmas || $tienePermisoInforme || 
                            $tienePermisoConformidad;
    ...
    @if(!$tieneAlgunPermiso)
        ...
        <div class="no-permission-message">
            ...
            <div class="mt-4">
                <a href="{{ route('ordenes.helpdesk') }}" class="btn btn-primary">Volver a Órdenes</a>
            </div>
        </div>
    @else
        ...
        <div class="mb-5" x-data="{
            ...
            <ul class="grid grid-cols-4 gap-2 sm:flex sm:flex-wrap sm:justify-center mt-3 mb-5 sm:space-x-3 rtl:space-x-reverse">
                @if (!$esRol6)
                    ...
                    <!-- Tab Constancia - Con condición original + permiso -->
                    @if ($tipoServicio == 6 && $orden->clienteGeneral && $orden->clienteGeneral->idClienteGeneral != 6 && $tienePermisoConstancia)
                        <li>
                            <a href="javascript:;"
                                class="p-5 sm:p-7 py-2 sm:py-3 flex flex-col items-center justify-center rounded-lg bg-[#f1f2f3] dark:bg-[#191e3a] hover:!bg-success hover:text-white hover:shadow-md transition-all text-xs sm:text-sm"
                    ...
                    <!-- Tab Retorno - Con condición original + permiso -->
                    @if ($existeFlujo31 && $tienePermisoRetorno)
                        <li>
                            <a href="javascript:;"
                                class="p-5 sm:p-7 py-2 sm:py-3 flex flex-col items-center justify-center rounded-lg bg-[#f1f2f3] dark:bg-[#191e3a] hover:!bg-success hover:text-white hover:shadow-md transition-all text-xs sm:text-sm"
                    ...
                    <!-- Tab Imagenes - Con condición original + permiso -->
                    @if (($tipoServicio == 1 || $tipoServicio == 5 || $tipoServicio == 6) && $tienePermisoImagenes)
                        <li>
                            <a href="javascript:;"
                                class="p-5 sm:p-7 py-2 sm:py-3 flex flex-col items-center justify-center rounded-lg bg-[#f1f2f3] dark:bg-[#191e3a] hover:!bg-success hover:text-white hover:shadow-md transition-all text-xs sm:text-sm"
                    ...
                    <!-- Tab Recursos - Con condición original + permiso -->
                    @if ($tipoServicio == 2 && $tienePermisoRecursos)
                        <li>
                            <a href="javascript:;"
                                class="p-5 sm:p-7 py-2 sm:py-3 flex flex-col items-center justify-center rounded-lg bg-[#f1f2f3] dark:bg-[#191e3a] hover:!bg-success hover:text-white hover:shadow-md transition-all text-xs sm:text-sm"
                    ...
                    <!-- Tab Ver Envío - Con condición original -->
                    @if ($existeFlujo25)
                        <li>
