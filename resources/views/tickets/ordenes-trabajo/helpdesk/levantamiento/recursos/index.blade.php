<div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md mt-6">
    <div class="flex justify-between items-center mb-4">
        <span class="text-sm sm:text-lg font-semibold badge"
            style="background-color: {{ $colorEstado }};">Articulos</span>
        <!-- Botón para refrescar la tabla -->
        @if (\App\Helpers\PermisoHelper::tienePermiso('REFRESCAR TABLA RECURSOS HELP DESK LEVANTAMIENTO'))
    ...
    <div class="mt-4 mb-6 flex items-center gap-4">
        ...
        <select id="articuloSelect" class="w-56 herramienta-select">
            ...
            @foreach ($articulos as $articulo)
                <option value="{{ $articulo->idArticulos }}" data-tipo="{{ $articulo->idTipoArticulo }}"
                    data-nombre="{{ $articulo->nombre }}" data-marca="{{ $articulo->marca_nombre }}"
        ...
        @if (\App\Helpers\PermisoHelper::tienePermiso('AGREGAR RECURSOS HELP DESK LEVANTAMIENTO'))
    ...
    <div class="flex justify-end mt-4">
        @if (\App\Helpers\PermisoHelper::tienePermiso('GUARDAR RECURSOS HELP DESK LEVANTAMIENTO'))
                ...
                fetch(`/get-suministros/${ticketId}/${visitaId}`)
                    ...
                    .then(data => {
                        ...
                        data.forEach(item => {
                            ...
                            const existe = articulosSeleccionados.some(art => art.id == item
                                .idArticulos);
                            ...
                            if (!existe) {
                                ...
                                console.warn('Artículo duplicado detectado y omitido:', item
                                    .idArticulos);
                            }
                        });
