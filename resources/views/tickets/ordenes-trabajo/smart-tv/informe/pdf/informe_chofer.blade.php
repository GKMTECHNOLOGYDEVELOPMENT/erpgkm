            ...
            <div class="flex justify-between mt-6">
                ...
                <div class="w-1/2">
                    <ul class="text-xs space-y-1">
                        <li><span class="font-bold">CLIENTE:</span> <span class="uppercase">{{ $orden->cliente->nombre ?? 'No asignado' }}</span></li>
                        <li><span class="font-bold">DNI/RUC:</span> <span class="uppercase">{{ $orden->cliente->documento ?? 'No disponible' }}</span></li>
                        <li><span class="font-bold">DIRECCIÓN:</span> <span class="uppercase">{{ $orden->direccion ?? 'No registrada' }}</span></li>
                ...
                <div class="w-1/2 text-right text-xs">
                    ...
                    @foreach ($visitas as $visita)
                        <div class="text-right space-y-1">
                            {{-- Nombre en una sola fila completa --}}
                            <p><span class="font-bold">NOMBRE:</span> {{ strtoupper(trim($visita['tecnico'])) }}</p>

                            {{-- DNI y PLACA en dos columnas --}}
                ...
                <div class="w-full text-xs mt-3">
                    <div class="flex justify-between flex-wrap gap-4">
                        ...
                        <p><span class="font-bold">MARCA:</span> <span
                                class="uppercase">{{ $producto['marca'] }}</span>
                        </p>
