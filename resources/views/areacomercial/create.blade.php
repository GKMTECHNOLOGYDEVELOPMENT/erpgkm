                ...
                <form id="formCliente" class="space-y-5" method="POST" action="{{ route('Seguimiento.store') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input id="nombre" name="nombre" type="text" placeholder="Ingrese nombre completo"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input id="documento" name="documento" type="text" placeholder="Ingrese documento"
                                    class="form-input" required />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input id="telefono" name="telefono" type="text" placeholder="Ingrese teléfono"
                                class="form-input" required />
                        </div>
                        <div>
                            <label for="email">Email <span class="text-danger">*</span></label>
                            <input id="email" name="email" type="email" placeholder="Ingrese email"
                                class="form-input" required />
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select id="idservicio" name="idservicio" class="form-select" required>
                                    ...
                                    .flat();
                                        ...
                                        function showErrorsSequentially(index) {
                                            if (index < errorMessages.length) {
                                                toastr.error(errorMessages[index],
                                                    'Error de validación', {
                                                        onHidden: function() {
                                                            // Mostrar el siguiente error cuando se cierre el actual
                                                            showErrorsSequentially(index +
                                                                1);
                                                        }
                                                    });
                                            }
