...
@isset($empresa)
    <form id="formEmpresa" class="space-y-6" action="{{ route('empresasformem.update', $empresa->id) }}" method="POST">
        ...
        <div class="form-group">
            <label class="block text-sm font-medium text-gray-700 mb-1">Nombre o Razón Social <span
        ...
        <div class="form-group">
            <label class="block text-sm font-medium text-gray-700 mb-1">Rubro o Giro Comercial <span
                    class="text-red-500">*</span></label>
            <div class="flex">
                <div
                    class="bg-[#eee] flex justify-center items-center ltr:rounded-l-md rtl:rounded-r-md px-3 font-semibold border ltr:border-r-0 rtl:border-l-0 border-[#e0e6ed] dark:border-[#17263c] dark:bg-[#1b2e4b]">
        ...
        <div class="form-group">
            <label class="block text-sm font-medium text-gray-700 mb-1">Ubicación Geográfica <span
                    class="text-red-500">*</span></label>
            <div class="flex">
                <div
                    class="bg-[#eee] flex justify-center items-center ltr:rounded-l-md rtl:rounded-r-md px-3 font-semibold border ltr:border-r-0 rtl:border-l-0 border-[#e0e6ed] dark:border-[#17263c] dark:bg-[#1b2e4b]">
        ...
        <!-- Fuente de Captación -->
        <div class="form-group">
            <label class="block text-sm font-medium text-gray-700 mb-1">Fuente de Captación <span
                    class="text-red-500">*</span></label>
            <div class="flex">
                <div
                    class="bg-[#eee] flex justify-center items-center ltr:rounded-l-md rtl:rounded-r-md px-3 font-semibold border ltr:border-r-0 rtl:border-l-0 border-[#e0e6ed] dark:border-[#17263c] dark:bg-[#1b2e4b]">
        ...
        form.addEventListener('submit', function(e) {
            ...
            fetch(url, {
                    ...
                    headers: {
                        ...
                        'X-Requested-With': 'XMLHttpRequest' // 👈 este es CLAVE
                    },
                ...
                .catch(error => {
                    if (error.errors) {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
                            text: error.message || 'Error inesperado al actualizar.'
                        });
                    }
                });
        });
