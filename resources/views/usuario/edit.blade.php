                                ...
                                <div class="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-5">
                                    ...
                                    <div>
                                        ...
                                        <input id="Nombre" name="Nombre" type="text"
                                            value="{{ $usuario->Nombre }}" class="form-input" />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input id="documento" name="documento" type="text"
                                            value="{{ $usuario->documento }}" class="form-input" />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input id="correo" name="correo" type="email"
                                            value="{{ $usuario->correo }}" class="form-input" />
                                    </div>
                                ...
                                <div class="mb-5">
                                    ...
                                    <form id="direccion-form">
                                        ...
                                        <div class="mb-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                <label for="departamento"
                                                    class="block text-sm font-medium">Departamento</label>
                                                ...
                                                <div id="departamento-error" class="text-red-500 text-sm"
                                        ...
                                        <div class="mb-5">
                                            <div>
                                                <label for="provincia"
                                                    class="block text-sm font-medium">Provincia</label>
                                            ...
                                            <div>
                                                <label for="distrito"
                                                    class="block text-sm font-medium">Distrito</label>
                                            ...
                                            <div>
                                                <label for="direccion"
                                                    class="block text-sm font-medium">Dirección</label>
                                                <input id="direccion" name="direccion" type="text"
                                                    class="form-input w-full"
                                                    value="{{ old('direccion', $usuario->direccion) }}"
                                                    placeholder="Ingrese la dirección">
                                                <div id="direccion-error" class="text-red-500 text-sm"
                                                    style="display: none;"></div>
                                            </div>
                                        </div>
