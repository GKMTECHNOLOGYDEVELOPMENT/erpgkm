                                ...
                                <form @submit.prevent="saveEvent">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input id="dateStart" type="datetime-local" name="start" id="start"
                                            ...
                                            :min="getNowDateTime()" @change="startDateChange($event)"
                                            :disabled="isInvitadoOnly()" required />
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input id="dateEnd" type="datetime-local" name="end" id="end"
                                            class="form-input" :disabled="isInvitadoOnly()"
                                            placeholder="Event End Date" x-model="params.end" :min="getNowDateTime()"
                                            required />
