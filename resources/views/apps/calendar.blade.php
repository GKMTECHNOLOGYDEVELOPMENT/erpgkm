...
<div x-data="calendar">
        ...
        <div class="flex items-center mt-2 flex-wrap sm:justify-start justify-center">
            <template x-for="etiqueta in etiquetas" :key="etiqueta.id">
                <div class="flex items-center ltr:mr-4 rtl:ml-4 group">
                    ...
                    <button @click="editEtiqueta(etiqueta)" class="text-gray-400 hover:text-blue-500 invisible group-hover:visible">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                        </svg>
                    </button>
                    <button @click="deleteEtiqueta(etiqueta.id)" class="text-gray-400 hover:text-red-500 invisible group-hover:visible">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="flex gap-2">      
        ...
        <button type="button" class="btn btn-success" @click="showEtiquetaModal()">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ltr:mr-2 rtl:ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<div class="fixed inset-0 bg-[black]/60 z-[999] overflow-y-auto hidden" :class="isEtiquetaModal && '!block'">
    <div class="flex items-center justify-center min-h-screen px-4" @click.self="isEtiquetaModal = false">
                ...
                <form @submit.prevent="saveEtiqueta">
                    <div class="mb-5">
                        ...
                        <input id="etiquetaNombre" type="text" class="form-input" 
                            placeholder="Nombre de la etiqueta" x-model="etiquetaParams.nombre" required />
                    </div>
                    
                    <div class="mb-5">
                        <label for="etiquetaColor">Color:</label>
                        <select id="etiquetaColor" class="form-select" x-model="etiquetaParams.color" required>
                    ...
                    <div class="flex justify-end items-center mt-8">
                        <button type="button" x-show="etiquetaParams.id" @click="deleteEtiqueta(etiquetaParams.id)" 
                                ...
                                <form @submit.prevent="saveEvent">
                                    <div class="mb-5">
                                        ...
                                        <input id="title" type="text" name="title" id="title"
                                            class="form-input" placeholder="Reunión"
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <input id="enlaceevento" type="url" name="enlaceevento" class="form-input" placeholder="https://erp.beyritech.com/actividad"
                                            x-model="params.enlaceevento" />
                                    </div>

                                    <div class="mb-5">
                                        <label for="ubicacion">Ubicacion (Opcional) :</label>
                                        <input id="ubicacion" type="text" name="ubicacion" class="form-input" placeholder="Av Sta Elvira E Mz B Lt 8, Los Olivos 15306"
