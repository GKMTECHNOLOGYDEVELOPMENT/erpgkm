...
<div class="form-section bg-white rounded-2xl shadow-lg p-6 md:p-8 mt-6 border border-gray-200">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-gradient-to-br from-blue-50 to-white p-6 rounded-2xl border border-blue-100">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                        <label for="departamento" class="block text-sm text-gray-600 mb-2 font-medium">Departamento</label>
    ...
    <div class="mb-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            <div>
                <label for="tipo_documento" class="block text-gray-700 font-medium mb-2 required">Tipo de Documento</label>
                <div class="relative">
        ...
        <div class="bg-gradient-to-br from-gray-50 to-white p-6 rounded-2xl border border-gray-200">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4">
                <div class="sm:col-span-2 lg:col-span-2">
                    <label for="direccion" class="block text-sm text-gray-600 mb-2 font-medium">Jr/Calle/Paseo/Av</label>
                    <div class="relative">
                ...
                <div>
                    <label for="urb_localidad" class="block text-sm text-gray-600 mb-2 font-medium">Urb. o Localidad</label>
                    <div class="relative">
                ...
                <div>
                    <label for="departamento_dir" class="block text-sm text-gray-600 mb-2 font-medium">Departamento</label>
                    <div class="relative">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <i class="fas fa-map-marked-alt text-gray-400 absolute left-3 top-1/2 transform -translate-y-1/2"></i>
                    </div>
                </div>
                <div>
    ...
    <div class="mb-10">
        ...
        <div class="bg-gradient-to-br from-gray-50 to-white p-6 rounded-2xl border border-gray-200">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                <div class="lg:col-span-1">
                    <label for="entidad_bancaria" class="block text-sm text-gray-600 mb-2 font-medium">Entidad Bancaria</label>
                    <div class="relative">
                ...
                <div class="lg:col-span-1">
                    <label for="tipo_cuenta" class="block text-sm text-gray-600 mb-2 font-medium">Tipo de Cuenta</label>
                    <div class="relative">
                ...
                <div class="lg:col-span-1">
                    <label for="numero_cuenta" class="block text-sm text-gray-600 mb-2 font-medium">Número de Cuenta</label>
                    <div class="relative">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    ...
                    @foreach ($seguros as $seguro)
                        <div class="flex items-center p-3 border border-gray-200 rounded-xl hover:bg-green-50 transition-colors">
                            <input type="checkbox" id="{{ $seguro['id'] }}" name="seguro_salud[]" value="{{ $seguro['value'] }}"
                                class="h-5 w-5 text-green-600 rounded focus:ring-green-500">
                            <label for="{{ $seguro['id'] }}" class="ml-3 text-gray-700 cursor-pointer flex-1">{{ $seguro['label'] }}</label>
                        </div>
                    @endforeach
                </div>
            </div>
