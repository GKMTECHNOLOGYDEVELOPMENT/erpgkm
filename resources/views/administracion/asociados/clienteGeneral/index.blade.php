                ...
                .then(data => {
                    if (data.success) {
                        ...
                        if (typeof Alpine !== 'undefined') {
                            ...
                            Alpine.store('imagenPreview',
                                '/assets/images/file-preview.svg'); // Restablecer a la imagen predeterminada
                            Alpine.store('imagenActual',
                                '/assets/images/file-preview.svg'); // Actualizar la imagen actual
                        }
