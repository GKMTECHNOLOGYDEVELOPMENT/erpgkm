{{-- resources/views/administracion/asociados/usuarios-por-cliente.blade.php --}}
<x-layout.default>
    ...
    <div class="panel mt-6">
        <div class="flex items-center justify-between mb-5">
            ...
            <div class="flex gap-2">
                <button type="button" class="btn btn-primary" onclick="abrirModalCrearUsuario({{ $clienteGeneral->idClienteGeneral }})">
            ...
            <table class="min-w-full divide-y divide-gray-200" id="tablaUsuarios">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Nombre Completo</th>
                        <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Documento</th>
                        <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Teléfono</th>
                        <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Correo</th>
                        <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Rol</th>
                        ...
                        <form @submit.prevent="guardarUsuario">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="text" x-model="form.nombreCompleto" 
                                        class="form-input w-full" placeholder="Ej: Juan Carlos Pérez" required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" x-model="form.apellidoPaterno" 
                                        class="form-input w-full" placeholder="Ej: Pérez" required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" x-model="form.apellidoMaterno" 
                                        class="form-input w-full" placeholder="Ej: García">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" x-model="form.numeroDocumento" 
                                        class="form-input w-full" placeholder="Ej: 12345678" required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="email" x-model="form.correoPersonal" 
                                        class="form-input w-full" placeholder="Ej: usuario@email.com" required>
                                </div>
                                    ...
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div class="flex items-center">
                                            <input type="checkbox" id="activo" 
                                                x-model="form.activo" class="form-checkbox">
                            ...
                            <div class="flex justify-end items-center mt-8 gap-2">
                                ...
                                <button type="submit" class="btn btn-primary" :disabled="cargando">
                                    <svg v-if="!cargando" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 mr-1">
                ...
                <div x-show="open" x-transition.duration.300
                    ...
                    <div class="p-5 text-center">
                        ...
                        <div class="flex justify-center gap-4">
                            ...
                            <button type="button" class="btn btn-danger" @click="confirmarEliminar" :disabled="cargando">
                ...
                guardarUsuario() {
                    ...
                    .then(data => {
                        ...
                        if (data.success) {
                            ...
                            if (data.errors) {
                                let mensajes = 'Errores encontrados:\n';
