<x-layout.default>
    ...
    <div>
        <ul class="flex space-x-2 rtl:space-x-reverse">
            <li>
                <a href="{{ route('administracion.proveedores') }}" class="text-primary hover:underline">Proveedores</a>
            </li>
        ...
        <div class="p-5">
            <form id="proveedorForm" class="grid grid-cols-1 md:grid-cols-2 gap-4" method="POST"
                ...
                <div class="md:col-span-2 flex justify-end mt-4">
                    ...
                    @if(\App\Helpers\PermisoHelper::tienePermiso('ACTUALIZAR PROVEEDORES'))   
