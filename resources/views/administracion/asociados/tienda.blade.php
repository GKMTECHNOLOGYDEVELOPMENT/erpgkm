                ...
                <div class="flex flex-wrap items-center justify-center gap-2 mb-5 sm:justify-start md:flex-nowrap">
                    ...
                    <button type="button" class="btn btn-primary btn-sm flex items-center gap-2"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="none"
                            viewBox="0 0 21 21">
                            <path
                                d="M5 13V20C5 20.5523 5.44772 21 6 21H9C9.55228 21 10 20.5523 10 20V16H14V20C14 20.5523 14.4477 21 15 21H18C18.5523 21 19 20.5523 19 20V13"
    ...
    <script>
        document.addEventListener("alpine:init", () => {
            Alpine.data("multipleTable", () => ({
                datatable1: null,
                tiendaData: [], // Agrega una propiedad para almacenar los datos

                init() {
                    // Llamar a la API para obtener los datos de 'tiendas'
                    fetch('/api/tiendas') // Ajusta la URL si es necesario
                        ...
                        .then(data => {
                            ...
                            this.datatable1 = new simpleDatatables.DataTable('#myTable1', {
                                data: {
                                    headings: ['ID Tienda', 'Nombre',
                                        '<div class="text-center">Acciones</div>'
                                    ],
                                    data: this.tiendaData.map(tienda => [
                                        tienda.idTienda,
                                        tienda.nombre,
                                        ''
                                    ]),
                                ...
                                labels: {
                                    ...
                                    perPage: "{select} resultados por página", // Selección de resultados por página
                                    noRows: "No se encontraron registros", // Mensaje sin registros
                                    info: "Mostrando {start} a {end} de {rows} registros", // Información de la tabla
                                },
                                layout: {
                                    top: "{search}",
