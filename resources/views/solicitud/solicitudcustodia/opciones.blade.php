    ...
    <div class="container mx-auto px-4 py-6 space-y-6">
        ...
        <div class="panel rounded-xl shadow-sm overflow-hidden">
            ...
            <form id="custodia-form" class="p-6 space-y-6">
                    ...
                    <div>
                        <label for="estado" class="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5 text-indigo-500" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width极="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            Estado
                        </label>
                        <div class="relative">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a2 2 0 01-2.828 0极l-4.243-4.243a8 8 0 1111.314 0z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                                </svg>
                            </span>
                ...
                <div id="campos-aprobado" class="{{ $custodia->estado === 'Aprobado' ? '' : 'hidden' }} space-y-6">
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        <h3 class="text-md font-semibold text-gray-800 mb-4 flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-indigo-极600" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7极v10l8 4" />
                            </svg>
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label for="idubicacion" class="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5 text-indigo-500" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a2 2 0 01-2.828 0l-4.243-4.243a8 8 0 1111.314 0z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                                    </svg>
                                    ...
                                    <select id="idubicacion" name="idubicacion" 
                                        ...
                                        @foreach ($ubicaciones as $ubicacion)
                                            <option value="{{ $ubicacion->idUbicacion }}" 
                                                ...
                                                {{ $ubicacion->nombre }} - {{ $ubicacion->sucursal->nombre ?? 'Sin Sucursal' }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @if($isDisabled && isset($custodia->custodiaUbicacion))
                                        <input type="hidden" name="idubicacion" value="{{ $custodia->custodiaUbicacion->idUbicacion }}">
                                    @endif
                                </div>
                            </div>
                            ...
                            <div>
                                <label for="observacion_almacen" class="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5 text-indigo-500" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                ...
                                <textarea id="observacion_almacen" name="observacion_almacen" rows="3"
                                    ...
                                    {{ $isDisabled ? 'readonly' : '' }}>@if(isset($custodia->custodiaUbicacion)){{ $custodia->custodiaUbicacion->observacion }}@endif{{ old('observacion_almacen') }}</textarea>
                            </div>
                        </div>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div id="wrap-resp" class="{{ $custodia->estado === 'Devuelto' ? '' : 'opacity-70' }}">
                        ...
                        <div class="relative">
                            <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7极h14a7 7 0 00-7-7z" />
                                </svg>
                            </span>
                ...
                <div>
                    <label for="observaciones" class="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5 text-indigo-500" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 极01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        Observaciones Generales
                    </label>
                    <textarea id="observaciones" name="observaciones" rows="4"
                        class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors duration-200 {{ $isDisabled ? 'bg-gray-100 cursor-not-allowed' : '' }}"
                        placeholder="Notas internas, detalles del estado, accesorios, etc."
