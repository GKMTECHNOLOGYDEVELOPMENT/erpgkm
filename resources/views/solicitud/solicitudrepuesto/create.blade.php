                    ...
                    <div class="mb-4 lg:mb-0">
                        ...
                        <div class="flex flex-wrap gap-6 text-sm">
                            <div class="flex items-center">
                                ...
                                <span class="text-[#3b3f5c]">Usuario: <strong class="text-[#0e1726]">Administrador Principal</strong></span>
                            </div>
                            <div class="flex items-center">
                ...
                <div class="xl:col-span-3 space-y-8">
                    ...
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-[#eaf1ff]">
                        <div class="bg-[#4361ee] px-6 py-4">
                            <div class="flex items-center space-x-3">
                                <div class="flex items-center justify-center w-10 h-10 bg-white text-[#4361ee] rounded-full font-bold text-lg">
                                    1
                                </div>
                                <div>
                        ...
                        <div class="p-6">
                                ...
                                <div class="overflow-hidden rounded-lg border border-[#eaf1ff]">
                                    <table class="w-full">
                                        <thead class="bg-[#eaf1ff]">
                                            <tr>
                                                <th class="px-6 py-4 text-left text-sm font-semibold text-[#4361ee] uppercase tracking-wider">Modelo</th>
                                                <th class="px-6 py-4 text-left text-sm font-semibold text-[#4361ee] uppercase tracking-wider">Tipo de Repuesto</th>
                                                <th class="px-6 py-4 text-left text-sm font-semibold text-[#4361ee] uppercase tracking-wider">Código</th>
                                                <th class="px-6 py-4 text-left text-sm font-semibold text-[#4361ee] uppercase tracking-wider">Cantidad</th>
                                                <th class="px-6 py-4 text-left text-sm font-semibold text-[#4361ee] uppercase tracking-wider">Acciones</th>
                                            </tr>
                                        </thead>
                                        <tbody id="products-table-body" class="bg-white divide-y divide-[#eaf1ff]">
                                            <tr id="empty-state" class="text-center">
                                                <td colspan="5" class="px-6 py-12 text-[#3b3f5c]">
                                                    <svg class="mx-auto h-16 w-16 text-[#eaf1ff]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="bg-[#eaf1ff] rounded-xl p-6 border border-[#4361ee]/20">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                                    ...
                                    <div>
                                        <label class="block text-sm font-semibold text-[#3b3f5c] mb-3">Tipo de Repuesto</label>
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center bg-white rounded-lg border border-[#eaf1ff] overflow-hidden">
                                            <button type="button" id="decrease-qty" class="p-3 bg-[#eaf1ff] hover:bg-[#4361ee] hover:text-white text-[#4361ee] transition-colors duration-200">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H4"></path>
                                                </svg>
                                            </button>
                                            <input type="number" id="cantidad-input" value="1" min="1" max="100"
                                                   class="flex-1 px-3 py-3 text-center focus:outline-none bg-white text-[#0e1726] font-semibold">
                                            <button type="button" id="increase-qty" class="p-3 bg-[#eaf1ff] hover:bg-[#4361ee] hover:text-white text-[#4361ee] transition-colors duration-200">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-[#eaf1ff]">
                        <div class="bg-[#2196f3] px-6 py-4">
                            <div class="flex items-center space-x-3">
                                <div class="flex items-center justify-center w-10 h-10 bg-white text-[#2196f3] rounded-full font-bold text-lg">
                                    2
                                </div>
                                <div>
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                ...
                                <div>
                                    <label class="block text-lg font-semibold text-[#0e1726] mb-4">Tipo de Servicio</label>
                                ...
                                <!-- Nivel de Urgencia -->
                                <div>
                                    <label class="block text-lg font-semibold text-[#0e1726] mb-4">Nivel de Urgencia</label>
                                    <div class="grid grid-cols-3 gap-3">
                                        <button type="button" class="py-4 px-4 border-2 border-[#00ab55] rounded-lg text-sm font-bold bg-[#ddfff0] text-[#00ab55] hover:bg-[#00ab55] hover:text-white transition-all duration-200">
                                            🟢 Baja
                                        </button>
                                        <button type="button" class="py-4 px-4 border-2 border-[#e2a03f] rounded-lg text-sm font-bold bg-[#fff9ed] text-[#e2a03f] hover:bg-[#e2a03f] hover:text-white transition-all duration-200">
                                            🟡 Media
                                        </button>
                                        <button type="button" class="py-4 px-4 border-2 border-[#e7515a] rounded-lg text-sm font-bold bg-[#fff8f5] text-[#e7515a] hover:bg-[#e7515a] hover:text-white transition-all duration-200">
                                            🔴 Alta
                                        </button>
                                    </div>
                                </div>
                            ...
                            <!-- Observaciones -->
                            <div class="mt-8">
                                <label class="block text-lg font-semibold text-[#0e1726] mb-4">Observaciones y Comentarios</label>
                                <textarea rows="5" 
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6 border border-[#eaf1ff]">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex justify-between items-center py-3">
                                ...
                                <span class="px-3 py-1 bg-[#fff9ed] text-[#e2a03f] rounded-full text-sm font-bold">Pendiente</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6 border border-[#eaf1ff]">
                        ...
                        <div class="space-y-4">
                            <button id="clear-all-btn" 
                                    class="w-full px-6 py-4 border-2 border-[#e7515a] text-[#e7515a] rounded-lg font-bold hover:bg-[#e7515a] hover:text-white transition-all duration-200 flex items-center justify-center space-x-3">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button class="w-full px-6 py-4 border-2 border-[#2196f3] text-[#2196f3] rounded-lg font-bold hover:bg-[#2196f3] hover:text-white transition-all duration-200 flex items-center justify-center space-x-3">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.codigo-select2').select2({
                ...
                ajax: {
                    ...
                    processResults: function (data, params) {
                        ...
                        var mockData = {
                            results: [
                                { id: 'N0404-002068', text: 'N0404-002068 - Pantalla Principal 65"' },
                                { id: 'N0404-002069', text: 'N0404-002069 - Pantalla Secundaria' },
                                { id: 'N0405-001234', text: 'N0405-001234 - Placa Base V2' },
                                { id: 'N0405-001235', text: 'N0405-001235 - Placa Base V3' },
                                { id: 'N0406-003456', text: 'N0406-003456 - Fuente 500W' }
                            ].filter(item => 
                ...
                templateResult: function (data) {
                    ...
                    var $result = $(
                        '<div class="flex items-center justify-between">' +
                            ...
                            '<span class="text-sm text-gray-500 ml-2">' + data.text.split(' - ')[1] + '</span>' +
                        '</div>'
                    );
            ...
            function updateStats() {
                ...
                document.getElementById('product-count').textContent = `${totalProducts} producto${totalProducts !== 1 ? 's' : ''}`;
            ...
            function showNotification(message, type = 'info') {
                ...
                notification.className = `fixed top-6 right-6 ${bgColor} text-white px-6 py-4 rounded-xl shadow-2xl transform transition-all duration-300 translate-x-full z-50 max-w-sm`;
