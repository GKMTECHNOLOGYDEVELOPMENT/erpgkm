<x-layout.default>
    ...
    <div x-data="warehouseEdit()" x-init="init()" class="warehouse-create-container">
        <!-- Header -->
        <div class="wc-header">
            <div class="wc-header-content">
                ...
                <div class="wc-title-section">
                    <h1>Editar Solicitud de Abastecimiento</h1>
                    <p>Modifique los productos necesarios para el almacén</p>
                </div>
                    ...
                    <div class="wc-card-header">
                        <div class="wc-header-with-code">
                            ...
                            <div class="wc-request-code">
                                ...
                                <span class="wc-code-value" x-text="solicitud.codigo_solicitud"></span>
                    ...
                    <div class="wc-card-header">
                        <div class="wc-header-with-action">
                            <div>
                                ...
                                <p>Modifique los productos que necesita el almacén</p>
                            </div>
            ...
            <div class="wc-preview-section">
                <div class="wc-preview-card">
                    ...
                    <div class="wc-preview-content">
                        <div class="wc-preview-status">
                            <div class="wc-status-badge" :class="'status-' + solicitud.estado" x-text="getStatusText(solicitud.estado)"></div>
                        </div>
                        ...
                        <div class="wc-preview-section">
                            ...
                            <div class="wc-preview-item">
                                <label>Código:</label>
                                <span class="wc-code-preview" x-text="solicitud.codigo_solicitud"></span>
                            </div>
                            <div class="wc-preview-item">
                                <label>Título:</label>
                ...
                <div class="wc-help-card">
                    ...
                    <ul class="wc-help-list">
                        <li>Puede modificar todos los campos excepto el código de solicitud</li>
                        <li>Los cambios se reflejarán inmediatamente en el sistema</li>
                        <li>Se registrará un evento en el historial de la solicitud</li>
                        <li>Verifique que las cantidades sean correctas</li>
                        <li>La solicitud mantendrá su estado actual durante la edición</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            return {
                ...
                async loadSolicitudData() {
                    try {
                        ...
                        if (data.success) {
                            ...
                            // DEBUG: Ver qué viene en la fecha
                            console.log('Fecha requerida original:', this.solicitud.fecha_requerida);
                            console.log('Tipo de fecha:', typeof this.solicitud.fecha_requerida);
                ...
                async searchArticle(index) {
                    ...
                    try {
                        ...
                        if (data.success && data.articulo) {
                            ...
                            // QUITAR: product.precio_unitario = articulo.precio_compra || 0;
                            ...
                            // QUITAR: product.moneda_simbolo = articulo.moneda_simbolo || '$';
                            // QUITAR: product.proveedor_sugerido = articulo.proveedor_nombre || '';
                ...
                addProduct() {
                    this.form.productos.push({
                        ...
                        marca_nombre: '',
                        modelo_nombre: '',
                        // QUITAR: moneda_simbolo: '$',
                        // QUITAR: proveedor_sugerido: '',
                        especificaciones: '',
                ...
                // QUITAR: updateProductTotal(index) { ... }
                ...
                async submitForm() {
                    ...
                    try {
                        const formData = {
                            ...this.form,
                            // QUITAR: subtotal: this.subtotal,
                            // QUITAR: iva: this.iva,
                            // QUITAR: total: this.total,
                            total_unidades: this.totalUnits
                        };

                        const response = await fetch('/solicitudalmacen/{{ $id }}', {
                            method: 'PUT',
                            headers: {
                        ...
                        if (result.success) {
                            alert(`¡Solicitud ${this.solicitud.codigo_solicitud} actualizada exitosamente!`);
                            // Redirigir al listado
                            window.location.href = '/solicitudalmacen';
                        } else {
                            alert('Error al actualizar la solicitud: ' + result.message);
                        }
                    } catch (error) {
                        console.error('Error:', error);
