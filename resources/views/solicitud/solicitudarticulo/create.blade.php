                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between lg:gap-8">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-gray-600 text-lg">Complete la información requerida para solicitar artículos o materiales</p>
                        </div>
                        ...
                        <div class="bg-gradient-to-r from-purple-600 to-indigo-600 px-6 py-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-purple-100 text-sm">Agregue los artículos o materiales que necesita</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-blue-100 text-sm">Complete los detalles de la solicitud</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-6 border border-blue-100">
                        ...
                        <div class="space-y-4">
                            ...
                            <button @click="createSolicitud()" :disabled="!canCreateSolicitud || isCreatingOrder"
                                ...
                                <span class="text-lg" x-text="isCreatingOrder ? 'Creando Solicitud...' : 'Crear Solicitud'"></span>
                            </button>
                        </div>
                    </div>
