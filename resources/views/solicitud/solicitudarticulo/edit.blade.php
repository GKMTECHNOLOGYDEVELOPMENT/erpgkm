                        ...
                        <div class="mb-4">
                            ...
                            <div x-show="solicitud.codigo_cotizacion" class="mt-3">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800">
                                    ...
                                    Cotización: <span x-text="solicitud.codigo_cotizacion" class="font-bold ml-1"></span>
                                </span>
                            </div>
                        </div>
                ...
                <div class="xl:col-span-3 space-y-8">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-blue-100 transition-all duration-300">
                        <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-white/80 text-sm">Actualice los artículos o materiales que necesita</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="bg-green-50 rounded-2xl p-6 border border-green-200 mb-6" x-show="!solicitud.codigo_cotizacion">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div x-show="selectedCotizacionInfo" class="bg-white rounded-lg p-4 border border-green-300">
                                        ...
                                        <div class="space-y-1 text-sm">
                                            <p><span class="font-medium">Número:</span> <span x-text="selectedCotizacionInfo.numero_cotizacion"></span></p>
                                            <p><span class="font-medium">Cliente:</span> <span x-text="selectedCotizacionInfo.cliente_nombre"></span></p>
                                            <p><span class="font-medium">Fecha:</span> <span x-text="formatDate(selectedCotizacionInfo.fecha_emision)"></span></p>
                                ...
                                <div x-show="cotizacionProducts.length > 0" class="mt-6">
                                        ...
                                        <table class="w-full">
                                            <thead class="bg-green-50">
                                                <tr>
                                                    ...
                                                    <th class="px-4 py-3 text-left text-sm font-semibold text-green-600">Tipo</th>
                                            ...
                                            <tbody class="bg-white divide-y divide-green-100">
                                                <template x-for="(product, index) in cotizacionProducts" :key="index">
                                                    <tr class="hover:bg-green-50 transition-colors">
                                                        <td class="px-4 py-3">
                                                            <div class="space-y-1">
                                                                <div class="text-sm font-medium text-gray-900" x-text="getArticuloNombre(product.articulo_id)"></div>
                                                                <div class="text-xs text-gray-500 space-y-0.5">
                                                                    <div class="flex items-center space-x-1" x-show="getArticuloTipo(product.articulo_id)">
                                                                        <span class="font-medium">Tipo:</span>
                                                                        <span x-text="getArticuloTipo(product.articulo_id)"></span>
                                                                    </div>
                                                                    <div class="flex items-center space-x-1" x-show="getArticuloModelo(product.articulo_id)">
                                                        ...
                                                        <td class="px-4 py-3 text-sm text-green-600 font-mono" x-text="getArticuloCodigo(product.articulo_id)"></td>
                                                        <td class="px-4 py-3 text-sm text-gray-700" x-text="getArticuloTipo(product.articulo_id)"></td>
                                                        <td class="px-4 py-3 text-sm text-gray-700" x-text="product.cantidad"></td>
                                                        <td class="px-4 py-3 text-sm">
                                                            <button @click="addProductFromCotizacion(product)" class="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 transition-colors font-medium text-sm flex items-center space-x-2">
                                    ...
                                    <div class="mt-4 flex justify-end">
                                        <button @click="addAllCotizacionProducts()" class="bg-blue-500 text-white px-6 py-3 rounded-lg hover:bg-blue-600 transition-colors font-bold flex items-center space-x-2">
                            ...
                            <div x-show="solicitud.codigo_cotizacion && cotizacionActual" class="bg-blue-50 rounded-2xl p-6 border border-blue-200 mb-6">
                                <h3 class="text-xl font-semibold text-gray-900 mb-4">Información de Cotización Actual</h3>
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        <p class="text-sm font-medium text-gray-600">Número de Cotización</p>
                                        <p class="text-lg font-bold text-blue-700" x-text="cotizacionActual.numero_cotizacion"></p>
                                    </div>
                                    <div>
                                        <p class="text-sm font-medium text-gray-600">Cliente</p>
                                        <p class="text-lg font-semibold text-gray-900" x-text="cotizacionActual.cliente_nombre"></p>
                                    </div>
                                    <div>
                                        <p class="text-sm font-medium text-gray-600">Fecha Emisión</p>
                                        <p class="text-lg font-semibold text-gray-900" x-text="formatDate(cotizacionActual.fecha_emision)"></p>
                                    </div>
                                </div>
                                <div class="mt-4">
                                    <p class="text-sm text-gray-600 italic">
                                        Esta solicitud está vinculada a una cotización. Los artículos no pueden ser modificados desde otras cotizaciones.
                                    </p>
                                </div>
                            </div>
                                    ...
                                    <table class="w-full">
                                        <thead class="bg-blue-50">
                                            <tr>
                                                ...
                                                <th class="px-6 py-4 text-center text-sm font-semibold text-blue-600 uppercase tracking-wider">Cantidad</th>
                                            ...
                                            <template x-if="products.length === 0">
                                                <tr>
                                                    <td colspan="4" class="px-6 py-12 text-center text-gray-500">
                                                        ...
                                                        <p class="text-sm mt-2">Agregue artículos usando el formulario inferior o desde una cotización aprobada</p>
                                                    </td>
                                                </tr>
                                            </template>
                                            <template x-for="(product, index) in products" :key="product.uniqueId">
                                                <tr class="product-row hover:bg-blue-50 transition-all duration-200">
                                                    ...
                                                    <td class="px-6 py-4">
                                                        <div class="space-y-1">
                                                            <!-- Nombre principal -->
                                                            <div class="text-base font-semibold text-gray-900" x-text="product.nombre"></div>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div class="text-base text-blue-600 font-mono font-bold" x-text="product.codigo"></div>
                                                        <div class="text-xs text-gray-400 mt-1" x-text="product.codigo_barras ? 'Cód. Barras' : 'Cód. Repuesto'"></div>
                                                    </td>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-base">
                                                        <button @click="removeProduct(index)" class="text-red-600 hover:text-red-700 font-semibold flex items-center space-x-2 transition-colors p-2 rounded-lg hover:bg-red-50">
                                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="bg-blue-50 rounded-2xl p-6 border border-blue-200" x-show="!solicitud.codigo_cotizacion">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center gap-2">
                                        <h2 class="text-xl font-bold text-white drop-shadow-sm">Información Adicional</h2>
                                        <span class="px-2 py-1 bg-white/20 rounded-full text-white text-xs font-medium border border-white/30">
                                            Requerido
                                        </span>
                                    </div>
                                    <p class="text-white/80 text-sm mt-1">Actualice los detalles de la solicitud</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <select x-model="orderInfo.tipoServicio" class="w-full pl-11 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 appearance-none bg-white cursor-pointer shadow-sm hover:shadow-md">
                                        ...
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-blue-700 font-medium">
                                                    <span x-text="formatDateForDisplay(orderInfo.fechaRequerida)"></span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="p-5 rounded-xl border-2 transition-all duration-300 h-full shadow-sm hover:shadow-md"
                                                ...
                                                <div class="flex items-center justify-between mb-3">
                                                    <div class="flex items-center space-x-2">
                                                        <i class="fas" :class="urgencia.icon + ' ' + urgencia.iconColor + ' text-xl'"></i>
