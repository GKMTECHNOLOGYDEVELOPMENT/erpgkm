        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
            ...
            <div class="flex flex-wrap gap-2 w-full sm:w-auto">
                ...
                <a href="{{ route('solicitudarticulo.edit', $solicitud->idSolicitud) }}" 
                   class="px-4 py-2 bg-amber-500 text-red rounded-lg hover:bg-amber-600 transition-all flex items-center shadow-sm hover:shadow-md">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="px-6 py-4 flex flex-wrap justify-end gap-3">
                ...
                <form action="#" method="POST">
                    @csrf
                    @method('PUT')
                    <button type="submit" class="px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-all flex items-center shadow-sm hover:shadow-md">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <form action="{{ route('solicitudarticulo.destroy', $solicitud->idSolicitud) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="px-4 py-2 bg-rose-600 text-white rounded-lg hover:bg-rose-700 transition-all flex items-center shadow-sm hover:shadow-md" onclick="return confirm('¿Estás seguro de eliminar esta solicitud?')">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
