        ...
        <div
                ...
                <div class="flex justify-between items-start mb-4">
                    ...
                    <div class="flex-1">
                        <div
                            ...
                            <span class="text-xs font-semibold text-gray-700">{{ $solicitud->codigo_solicitud }}</span>
                        </div>
                    ...
                    <div class="flex flex-col items-end">
                        <span
                            ...
                            @switch($solicitud->estado)
                                @case('pendiente')
                                    <svg class="w-3 h-3 mr-1 text-warning" fill="currentColor" viewBox="0 0 20 20"
                                        xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="px-5 pb-5">
                ...
                <div class="grid grid-cols-2 gap-2">
                    <!-- Fecha Requerida -->
                    <div class="flex items-center p-2 rounded-lg bg-blue-100 hover:bg-blue-100/50 transition-colors">
                        <div class="flex-shrink-0 w-8 h-8 flex items-center justify-center bg-blue-100 rounded-lg mr-2">
                    ...
                    <!-- Unidades -->
                    <div class="flex items-center p-2 rounded-lg bg-gray-100 hover:bg-gray-100/50 transition-colors">
                        <div
                                    ...
                                    <div
                                        ...
                                        <div class="flex-shrink-0">
                                            <div
                                                ...
                                                <span class="text-xs text-gray-500">{{ $detalle->unidad }}</span>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                            ...
                            @if (count($solicitud->detalles) > 2)
                                ...
                                <div class="text-center pt-2 mt-2 border-t border-gray-100">
                                    <span class="inline-flex items-center text-xs text-gray-500">
                                        <svg class="w-3 h-3 mr-1 animate-bounce" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <!-- Card Footer -->
            <div class="px-5 py-4 border-t border-gray-200 bg-gradient-to-r from-gray-50 to-white rounded-b-xl">
                <div class="flex items-center justify-between">
                    ...
                    <button onclick="verDetalle({{ $solicitud->idSolicitudCompra }})"
                        ...
                        <svg class="w-4 h-4 mr-2 group-hover/btn:rotate-12 transition-transform" fill="none"
                        ...
                        <div class="flex flex-col items-end">
                            ...
                            <div class="flex items-center">
                                @if ($solicitud->idPrioridad == 1)
                                    <div class="flex items-center">
                                        <div class="w-3 h-3 bg-danger rounded-full mr-1 animate-pulse"></div>
...
@else
    ...
    <div class="col-span-full">
        <div
            ...
            <p class="text-gray-600 max-w-md mx-auto mb-6">No se encontraron solicitudes con los filtros aplicados.</p>
        </div>
    </div>
@endif
